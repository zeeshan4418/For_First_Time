...
@section('content')
  <div class="col-lg-12">
    <div class="card">
      <form class="video" action="{{action('VideoController@store')}}" method="post" enctype="multipart/form-data">
        @csrf
        {{-- information --}}
        <div class="row">
          <div class="col-lg-12">
            <p class="head">general information</p>
            <input required class="form-control" placeholder="title" type="text" name="title">
            <textarea name="body" placeholder="your text body" class="form-control" rows="8" cols="80"></textarea>
          </div>
          {{-- rate --}}
          <div class="col-lg-4">
          ...
          {{-- quality --}}
          <div class="col-lg-4">
            <input required type="text" name="quality" class="form-control" placeholder="quality">
          </div>
          {{-- quality --}}
          {{-- release --}}
          <div class="col-lg-6">
            <input required type="text" name="release" class="form-control" placeholder="release date">
          </div>
          {{-- release --}}
          {{-- imdb --}}
          <div class="col-lg-6">
            <input required type="imdb" name="imdb" class="form-control" placeholder="imdb rate">
          </div>
          {{-- imdb --}}
        </div>
        {{-- end information --}}
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <input required type="text" name="trailer" placeholder="trailer" class="form-control">
            <input required type="text" name="server_1" placeholder="server_1" class="form-control">
            <input required type="text" name="server_2" placeholder="server_2" class="form-control">
            <input required type="text" name="server_3" placeholder="server_3" class="form-control">
            <input required type="text" name="server_4" placeholder="server_4" class="form-control">
            <input required type="text" name="server_5" placeholder="server_5" class="form-control">
            <input required type="text" name="server_6" placeholder="server_6" class="form-control">
            <hr>
            <input required type="text" name="down" placeholder="the download link" class="form-control">
            <hr>
            <p>your post image</p>
